...
<div class="actions container">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Download.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Download.id')), array('class' => 'btn')); ?></li>
