<div class="brandCategories index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $brandCategory['BrandCategory']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $brandCategory['BrandCategory']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $brandCategory['BrandCategory']['id']), array(), __('Are you sure you want to delete # %s?', $brandCategory['BrandCategory']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
