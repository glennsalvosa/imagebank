...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2015 at 12:22 AM
...
(103, 1, NULL, NULL, 'FormOnes', 204, 215),
...
(2, 'Penshoppe', 'Trial Brand here', '2015-01-25 02:56:08', '2015-01-25 02:56:08', 1),
(3, 'Loreal', 'Body stuff', '2015-01-27 01:50:11', '2015-01-27 01:50:11', 1);
...
--
-- Table structure for table `form_ones`
--

CREATE TABLE IF NOT EXISTS `form_ones` (
`id` int(255) NOT NULL,
...
--
-- Dumping data for table `form_ones`
--

INSERT INTO `form_ones` (`id`, `tracking`, `created`, `modified`, `status`) VALUES
(1, '123456890', '2015-01-25 08:16:32', '2015-01-25 08:16:32', 1);
...
--
-- Indexes for table `form_ones`
--
ALTER TABLE `form_ones`
 ADD PRIMARY KEY (`id`);
...
MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `form_ones`
--
ALTER TABLE `form_ones`
